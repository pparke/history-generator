...
138,236,205,93,222,114,67,29,24,72,243,141,128,195,78,66,215,61,156,180];
  ...
  perlinNoise (x, y) {
    ...
    let n00 = this.dot(this.grad2[grad00], x, y);
    let n10 = this.dot(this.grad2[grad10], x-1, y);
    let n01 = this.dot(this.grad2[grad01], x, y-1);
    let n11 = this.dot(this.grad2[grad11], x-1, y-1);
